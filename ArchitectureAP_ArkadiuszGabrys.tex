...
% author and title
\title{\large{Seminar Design Patterns und Anti-Patterns} \\
	\huge{\textsc{Architecture Anti-Patterns}}}
...
\lhead{\textsc{Architecture Anti-Patterns}}    % write document title
...
\include{Sections/StovepipeEnterprise}
\include{Sections/StovepipeSystem}
\include{Sections/VendorLockIn}
